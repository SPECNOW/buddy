...
static const hetINSTRUCTION_t het1PROGRAM[58U] =
{
    ...
    */
    {
        ...
        0x000055C0U,
        /* Control */
        (0x00004006U | (uint32)((uint32)24U << 8U) | (uint32)((uint32)3U << 3U)),
        /* Data */
        0x00000000U,
        /* Reserved */
        0x00000000U
    ...
    */
    {
        ...
        0x0000D5C0U,
        /* Control */
        (0x0000C006U | (uint32)((uint32)8U << 8U) | (uint32)((uint32)3U << 3U)),
        /* Data */
        0x00000000U,
        /* Reserved */
        0x00000000U
    ...
    */
    {
        ...
        0x00025440U,
        /* Control */
        (0x00024007U | (uint32)((uint32)2U << 8U) | (uint32)((uint32)3U << 4U)),
        /* Data */
        0x00000000U,
        /* Reserved */
        0x00000000U
    ...
    */
    {
        /* Program */
        0x00034E00U | (uint32)((uint32)1U << 6U)  | (uint32)(2U),
        /* Control */
        0x00000000U,
        /* Data */
        0x00000000U,
    ...
    */
    {
        /* Program */
        0x00036E80U | (uint32)((uint32)1U << 6U)  | (uint32)((2U) + 1U),
        /* Control */
        0x00000000U,
        /* Data */
        0x00000000U,
    ...
    */
    {
        ...
        0x00054201U,
        /* Control */
        (0x00004007U | (uint32)((uint32)1U << 22U) | (uint32)((uint32)24U << 8U) | (uint32)((uint32)3U << 3U)),
        /* Data */
        4224U,
        /* Reserved */
        0x00000000U
    ...
    */
    {
        ...
        0x0005C205U,
        /* Control */
        (0x0000C007U | (uint32)((uint32)1U << 22U) | (uint32)((uint32)8U << 8U) | (uint32)((uint32)3U << 3U)),
        /* Data */
        100224U,
        /* Reserved */
        0x00000000U
...
void pwmGetSignal(hetRAMBASE_t * hetRAM, uint32 pwm, hetSIGNAL_t* signal)
{
    ...
    if(hetRAM == hetRAM1)
    {
        signal->period = ((float64)pwmPeriod * 640.000F) / 1000.0F;
    }
    else
    {
