...
/* USER CODE END */
    ...
    pinMuxReg->PINMMR3 = PINMUX_PIN_27_MIBSPI1nCS_2 | PINMUX_PIN_36_EQEPA | PINMUX_PIN_37_EQEPB;
    
    pinMuxReg->PINMMR4 = PINMUX_PIN_38_EQEPI | PINMUX_PIN_39_MIBSPI1nCS_3 | PINMUX_PIN_58_ADEVT;
    
    pinMuxReg->PINMMR5 = PINMUX_PIN_68_MIBSPI1nENA;
    
    pinMuxReg->PINMMR6 = PINMUX_PIN_93_EQEPS;
