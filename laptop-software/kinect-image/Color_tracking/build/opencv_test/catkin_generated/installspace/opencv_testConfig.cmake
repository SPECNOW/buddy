...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'opencv_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ali/buddy/laptop-software/kinect-image/Color_tracking/install/${idir}'.  Ask the maintainer 'ali <ali@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ali/buddy/laptop-software/kinect-image/Color_tracking/install/lib;/opt/ros/hydro/lib)
